...
class CustomMedicineReminderPlan extends StatefulWidget {
  const CustomMedicineReminderPlan({
    super.key,
  });

  @override
  State<CustomMedicineReminderPlan> createState() =>
      _CustomMedicineReminderPlanState();
}

class _CustomMedicineReminderPlanState
    extends State<CustomMedicineReminderPlan> {
