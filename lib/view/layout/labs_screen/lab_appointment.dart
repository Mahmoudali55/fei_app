...
class LabsAppointment extends StatefulWidget {
  const LabsAppointment({super.key});

  @override
  State<LabsAppointment> createState() => _LabsAppointmentState();
}

class _LabsAppointmentState extends State<LabsAppointment> {
              ...
              Padding(
                ...
                child: Text(
                  DateFormat('MMMM yyyy')
                      .format(currentDate), // عرض الشهر والسنة
                ...
                child: ListView(
                  ...
                  children: List.generate(
                    ...
                    (index) {
                      ...
                      // تنسيق التاريخ كـ 'يوم الأسبوع، اليوم، الشهر'
