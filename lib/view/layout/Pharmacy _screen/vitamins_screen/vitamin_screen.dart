...
import 'package:fei_app/view/layout/Pharmacy%20_screen/widgets/custom_phramacy_screen.dart';
                ...
                tabs: [
                  ...
                  Tab(
                    child: Container(
                      ...
                      child: const Center(child: Text('Vitamin A')),
                    ),
                  ),
                  Tab(
                    child: Container(
                      ...
                      child: const Center(child: Text('Vitamin C')),
                    ),
                  ),
                  Tab(
                    child: Container(
                      ...
                      child: const Center(child: Text("Vitamin D")),
                    ),
                  ),
                ],
                dividerHeight: 0,
